...
const AllPosts = () => {
  ...
  // const user = JSON.parse(localStorage.getItem("user"));     // got by gpt but not work here so i use useeffect copy from app.jsx given by gpt why not simply i access it ?
      ...
      {loading ? (
        ...
        >
          {posts.map((post) => {
            ...
            const id = post._id;
            const link = `/community/sppost/${id}`;
              ...
              >
                ...
                <div style={{ padding: "1rem" }}>
                  ...
                  >
                    ...
                    <span onClick={()=>handlecomment(post._id)} style={{ color: "#333" , cursor:'pointer' }}>
                       {post.comments?.length || 0} Comments
                    </span>

                    <span onClick={()=>handleCopy(link)} style={{cursor:'pointer'}}> 
                        Share
                    </span>
                  </div>
                </div>
