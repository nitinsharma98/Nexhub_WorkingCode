...
import API from "../../../axiosconfig"; // ✅ using your custom axios instance
...
const Paidcodes = () => {
  ...
  const fetchCodes = async () => {
    try {
      const res = await API.get("/home/community/comV/codes"); // ✅ route from your router
